...
db = SQLite3::Database.open('D:\RubyProject\DoneApp\SourceManagement\DBSystem\my_base.db')
...
1000.times do
  ...
  db.execute('INSERT INTO "Students" (last_name, first_name, patronymic, git, phone, telegram, email)
                VALUES (?, ?, ?, ?, ?, ?, ?)',
